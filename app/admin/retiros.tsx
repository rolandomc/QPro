    ...
    <SafeAreaView style={s.container}>
      ...
      {loading ? (
        ...
        <FlatList
          ...
          ListEmptyComponent={
            <View style={s.empty}>
              <Text style={s.emptyEmoji}>{filtro === 'pendiente' ? '🎉' : '📭'}</Text>
              <Text style={s.emptyTitle}>{filtro === 'pendiente' ? '¡Sin pendientes!' : 'Sin registros'}</Text>
                ...
                <View style={s.cardBody}>
                  <View style={s.row}>
                    <View style={s.avatarCircle}>
                      <Text style={s.avatarTxt}>{(item.profiles?.username ?? 'U')[0].toUpperCase()}</Text>
                    </View>
                    <View style={{ flex: 1 }}>
                  ...
                  <View style={s.destinoBox}>
                    <Text style={s.destinoLabel}>{item.metodo === 'spei' ? 'CLABE' : 'Alias / CVU'}</Text>
                ...
                <View style={s.modalCard}>
                  ...
                  <View style={s.modalInfoRow}>
                    <View style={s.modalAvatarCircle}>
                      <Text style={s.modalAvatarTxt}>{(retiroActivo?.profiles?.username ?? 'U')[0].toUpperCase()}</Text>
                    </View>
                    <View>
