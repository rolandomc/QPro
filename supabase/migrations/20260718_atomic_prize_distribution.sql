-- Distribución atómica de premios para quinielas
...
BEGIN
  ...
  IF v_estado = 'finalizada' THEN
    RAISE EXCEPTION 'La quiniela ya fue finalizada';
  END IF;

  IF v_estado <> 'cerrada' THEN
    RAISE EXCEPTION 'La quiniela debe estar cerrada antes de distribuir premios';
  END IF;
