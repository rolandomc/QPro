...
import { StyleSheet, Text, View, ScrollView, TouchableOpacity, Alert, ActivityIndicator, RefreshControl, Modal, FlatList, TextInput } from 'react-native';
...
export default function AdminDashboardScreen() {
  ...
  const handleGuardarFecha = async () => {
    setSavingFecha(true);
    try {
      await QuinielasService.setProximaFecha(proximaFecha.trim() || null);
      Alert.alert('✅ Guardado', proximaFecha.trim()
      ...
      >
        ...
        {configExpanded && (
          <View style={styles.configBox}>
            <Text style={styles.configLabel}>Fecha y hora (ISO 8601)</Text>
            <Text style={styles.configHint}>Ejemplo: 2026-07-01T20:00:00</Text>
            <TextInput
              style={styles.configInput}
              value={proximaFecha}
              onChangeText={setProximaFecha}
              placeholder="2026-07-01T20:00:00"
            ...
            <View style={styles.configBtns}>
              ...
              <TouchableOpacity
                ...
                onPress={() => { setProximaFecha(''); QuinielasService.setProximaFecha(null); }}
              >
...
const styles = StyleSheet.create({
  ...
  configLabel:       { color: '#A0A0A0', fontSize: 12, marginBottom: 2 },
  configHint:        { color: '#505050', fontSize: 10, marginBottom: 8 },
  configInput:       { backgroundColor: '#1C1F26', color: '#FFF', borderRadius: 8, borderWidth: 1, borderColor: '#2A2D35', padding: 10, fontSize: 14, marginBottom: 10 },
  configBtns:        { flexDirection: 'row', gap: 10 },
  configBtn:         { flex: 1, paddingVertical: 10, borderRadius: 8, alignItems: 'center' },
