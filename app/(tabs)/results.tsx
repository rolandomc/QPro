  ...
  const renderEmpty = () => (
    <View style={styles.emptyBox}>
      ...
      <Text style={styles.emptySubtitle}>
        {tab === 'En Juego'
          ? 'Cuando participes en una quiniela abierta\naparecerá aquí.'
          : 'Las quinielas finalizadas\naparecerán aquí con tus resultados.'}
      </Text>
    </View>
  );
        ...
        <FlatList
          ...
          refreshControl={
            <RefreshControl
              ...
              onRefresh={() => { setRefreshing(true); loadParticipaciones(); }}
              tintColor="#2ECC71"
            />
          }
          ListHeaderComponent={
              ...
              {tab === 'En Juego' ? (
                <View style={styles.liveRow}>
                  ...
                  <View style={styles.countBadge}>
                    <Text style={styles.countText}>{enJuego.length}</Text>
                  </View>
                </View>
              ) : (
                <View style={styles.liveRow}>
                  <Text style={styles.sectionTitle}>📊 Resultados finales</Text>
                  <View style={[styles.countBadge, { backgroundColor: '#2A2D35' }]}>
                    <Text style={styles.countText}>{historial.length}</Text>
                  </View>
                </View>
              )}
            </View>
